...
import { updateLibraryBook } from '../services/dataService';
        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white">Edit Buku</h1>
                        <p className="text-slate-400 mt-1">Perbarui data buku: <span className="text-blue-400">{bookData.judul_buku}</span></p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <input type="text" name="judul_buku" value={formData.judul_buku} onChange={handleChange}
                                placeholder="Contoh: Matematika Kelas VII" className={inputClass} required />
                        </div>
